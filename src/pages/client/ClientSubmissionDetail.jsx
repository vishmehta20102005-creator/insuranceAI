  ...
  return (
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main" style={{ maxWidth: '1080px', margin: '0 auto', padding: '28px 24px 60px' }}>
        ...
        {/* ── Submitted Documents at That Specific Time ── */}
        <div className="card" style={{ marginBottom: '24px', padding: '24px 28px' }}>
          <div className="card-header" style={{ marginBottom: '18px' }}>
            <div>
              <h3 style={{ fontSize: '1.15rem', fontWeight: 600, color: 'var(--color-text)', margin: '0 0 4px' }}>
                Submitted Application Documents
              </h3>
              <p className="card-subtitle" style={{ margin: 0, color: 'var(--color-text-secondary)', fontSize: '0.875rem' }}>
                The exact document files uploaded by the applicant on {formattedDate} for this application attempt.
              </p>
            </div>
            <span
              style={{
          ...
          {docs.length > 0 ? (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0, flex: 1 }}>
                      ...
                      <div style={{ minWidth: 0, flex: 1 }}>
                        ...
                        <div
                          ...
                          title={doc.filename}
                        >
                          {doc.filename} • {formatFileSize(doc.file_size)} • Uploaded{' '}
                    ...
                    <div>
                      ...
                      >
                        {isViewing ? (
                          <>
                            <span className="btn-spinner-dark" style={{ width: '12px', height: '12px' }} />
                            Opening…
                          </>
                        ) : (
                          <>
            ...
            <div style={{ textAlign: 'center', padding: '24px', color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>
              No document files recorded for this submission.
            </div>
          )}
        </div>
